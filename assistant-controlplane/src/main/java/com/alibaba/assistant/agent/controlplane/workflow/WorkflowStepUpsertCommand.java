...
/**
 * Typed create/update command for workflow-step records.
 */
public record WorkflowStepUpsertCommand(
        String stepId,
        String stepName,
        String stepType,
        String connectorCode,
        String targetRef,
        java.util.List<String> allowedAuthProfiles,
        java.util.List<String> bindingStrategies,
