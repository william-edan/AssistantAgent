...
/**
 * Request payload for auth-profile create/update operations.
 */
public record ConnectorManagedAuthProfileRequest(
        String authType,
        String usagePolicy,
    ...
    public AuthProfileUpsertCommand toCommand() {
        return new AuthProfileUpsertCommand(
                authType,
                usagePolicy,
                tokenEndpoint,
                tokenHeaderName,
