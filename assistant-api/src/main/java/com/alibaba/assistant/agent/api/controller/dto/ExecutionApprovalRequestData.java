...
/**
 * API payload item for approval queue entries.
 */
public record ExecutionApprovalRequestData(
        String requestId,
        String runId,
        String artifactCode,
        String artifactType,
    ...
    public static ExecutionApprovalRequestData from(ExecutionApprovalRequestView view) {
        return new ExecutionApprovalRequestData(
                view.requestId(),
                view.runId(),
                view.artifactCode(),
                view.artifactType(),
