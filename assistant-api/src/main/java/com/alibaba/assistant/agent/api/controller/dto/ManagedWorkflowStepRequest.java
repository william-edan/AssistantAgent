...
import com.alibaba.assistant.agent.controlplane.workflow.WorkflowStepUpsertCommand;

import java.util.List;
import java.util.Map;

/**
 * Request payload for workflow-step create/update operations.
 */
public record ManagedWorkflowStepRequest(
        String stepId,
        String stepName,
        String stepType,
    ...
    public WorkflowStepUpsertCommand toCommand() {
        return new WorkflowStepUpsertCommand(
                stepId,
                stepName,
                stepType,
                connectorCode,
