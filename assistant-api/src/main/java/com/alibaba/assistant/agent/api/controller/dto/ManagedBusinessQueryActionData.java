...
/**
 * Managed business-query-action payload.
 */
public record ManagedBusinessQueryActionData(
    ...
    public static ManagedBusinessQueryActionData from(ResolvedBusinessQueryActionManagementView resolved) {
        return new ManagedBusinessQueryActionData(
                resolved.queryActionCode(),
                ...
                resolved.resultVisibilityPolicy(),
