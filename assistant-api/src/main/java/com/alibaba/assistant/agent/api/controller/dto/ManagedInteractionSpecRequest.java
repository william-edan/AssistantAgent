...
/**
 * Request payload for interaction-spec create/update operations.
 */
public record ManagedInteractionSpecRequest(
    ...
    public InteractionSpecUpsertCommand toCommand() {
        return new InteractionSpecUpsertCommand(
                slotSchema,
                askStrategy,
                autoFillRules,
                summaryLayout,
