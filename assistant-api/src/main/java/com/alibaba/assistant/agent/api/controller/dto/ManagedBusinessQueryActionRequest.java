...
/**
 * Request payload for business-query-action create/update operations.
 */
public record ManagedBusinessQueryActionRequest(
    ...
    public BusinessQueryActionUpsertCommand toCommand() {
        return new BusinessQueryActionUpsertCommand(
                operationBinding,
                allowedAuthProfiles,
                bindingStrategies,
                inputSchema,
