...
/**
 * API payload for approval request detail pages.
 */
public record ExecutionApprovalDetailData(
        String requestId,
        String runId,
        String artifactCode,
        String artifactType,
    ...
    public static ExecutionApprovalDetailData from(ExecutionApprovalDetailView view) {
        return new ExecutionApprovalDetailData(
                view.requestId(),
                view.runId(),
                view.artifactCode(),
                view.artifactType(),
