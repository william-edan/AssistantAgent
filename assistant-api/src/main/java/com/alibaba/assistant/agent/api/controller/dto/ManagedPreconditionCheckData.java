...
/**
 * Managed precondition-check payload.
 */
public record ManagedPreconditionCheckData(
        String checkCode,
        Map<String, Object> operationBinding,
        List<String> allowedAuthProfiles,
        List<String> bindingStrategies,
        Map<String, Object> inputSchema,
        Map<String, Object> checkExpression,
        Map<String, Object> failurePolicy,
        String status) {

    public static ManagedPreconditionCheckData from(ResolvedPreconditionCheckManagementView resolved) {
        return new ManagedPreconditionCheckData(
                resolved.checkCode(),
                resolved.operationBinding(),
                resolved.allowedAuthProfiles(),
                resolved.bindingStrategies(),
                resolved.inputSchema(),
                resolved.checkExpression(),
