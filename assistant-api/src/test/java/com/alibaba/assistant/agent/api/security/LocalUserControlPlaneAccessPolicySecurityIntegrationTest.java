...
import com.alibaba.assistant.agent.api.controller.LocalUserControlPlaneAccessPolicyController;
...
@ContextConfiguration(classes = LocalUserControlPlaneAccessPolicySecurityIntegrationTest.TestConfig.class)
@WebAppConfiguration
@ActiveProfiles("migration")
class LocalUserControlPlaneAccessPolicySecurityIntegrationTest {

    private static final String PATH = "/api/controlplane/spaces/enterprise-default/local-users/1001/controlplane-access-policy";
    ...
    @BeforeEach
    void setUp() {
        Mockito.reset(policyService, migrationAuthService, authorizationService);
    ...
    static class TestConfig {
        ...
        @Bean
        LocalUserControlPlaneAccessPolicyService localUserControlPlaneAccessPolicyService() {
            return mock(LocalUserControlPlaneAccessPolicyService.class);
        }
        ...
        @Bean
        LocalUserControlPlaneAccessPolicyController localUserControlPlaneAccessPolicyController(
                LocalUserControlPlaneAccessPolicyService policyService,
                MigrationControlPlaneAuthorizationService authorizationService) {
            return new LocalUserControlPlaneAccessPolicyController(policyService, authorizationService);
        }
