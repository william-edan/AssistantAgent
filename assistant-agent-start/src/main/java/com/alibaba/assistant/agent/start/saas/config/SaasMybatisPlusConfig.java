...
/**
 * MyBatis-Plus configuration for SaaS module.
 *
 * @author Assistant Agent Team
 * @since 1.0.0
 */
@Configuration
@MapperScan("com.alibaba.assistant.agent.start.saas.infrastructure.mybatis.mapper")
public class SaasMybatisPlusConfig {

    /**
     * Build MyBatis-Plus interceptor chain.
     *
     * @return interceptor
     */
    @Bean
